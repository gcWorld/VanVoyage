...
class _TripFormState extends State<TripForm> {
  ...
  void initState() {
    ...
    _usePhaseDates = _transitStartDate != null ||
        _transitEndDate != null ||
        _locationStartDate != null ||
        _locationEndDate != null;
  }
          ...
          children: [
            ...
            Card(
              child: SwitchListTile(
                ...
                subtitle: const Text(
                    'Configure different dates for travel to/from destination'),
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    if (value) {
                      ...
                      _locationEndDate ??=
                          _endDate.subtract(const Duration(days: 2));
                    }
                  });
                },
              ),
